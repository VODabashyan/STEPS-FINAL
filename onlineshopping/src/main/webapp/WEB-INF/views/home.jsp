					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="/onlineshopping/resources/images/slider1.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="/onlineshopping/resources/images/slider2.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="/onlineshopping/resources/images/slider3.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/slider4.jpg"
									alt="">
							</div>
						</div>
